      ...
      <div className="mx-auto max-w-3xl px-6 pb-24">
        <div className="space-y-16">
          ...
          <div className="prose prose-lg">
            ...
            <p><strong>Applications for both our fellowships are now open! Apply <a href="https://forms.gle/ESS1suCsBoGvva9v7">here</a> for policy, and <a href="https://forms.gle/2F5dw4Dm9NTAabqe9">here</a> for technical.</strong></p>
          </div>
